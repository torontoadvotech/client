      ...
      <div className='wrapper'>
        ...
        <div className='social-container'>
          <a
            ...
            target='_blank'
            aria-label="Go to Toronto Advotech's LinkedIn page"
          ...
          <a
            rel='noopener noreferrer'
            target='_blank'
            aria-label="Go to Toronto Advotech's Instagram profile"
          ...
          <a
            rel='noopener noreferrer'
            target='_blank'
            aria-label="Go to Toronto Advotech's Facebook page"
          ...
          <a
            rel='noopener noreferrer'
            target='_blank'
            aria-label="Go to Toronto Advotech's Twitter profile"
            href='https://twitter.com/toadvotech'
          >
            <FontAwesomeIcon icon={faTwitter} />
          </a>
        </div>
        <button aria-label='Scroll Up' className='scroll-top'>
